...
__default_var theme_color_user                             normal
__default_var theme_color_group                            yellow
__default_var theme_color_host                             brgreen
__default_var theme_color_separator                        black

__default_var theme_color_bracket                          brblue
__default_var theme_color_normal                           blue

__default_var theme_color_time                             black
...
function __theme_print_time
    ...
    print_colored " " (command date $theme_display_time_format) $theme_color_normal
end
